...
const menusByType: Record<SidebarUserType, MenuItem[]> = {
  embarcador: [
    ...
    { icon: () => <img src="/hub-icon.svg" alt="Hubinho" className="w-10 h-6" />, label: 'Hubinho', href: '/embarcador/assistente' },
  ...
  transportadora: [
    ...
    { icon: () => <img src="/hub-icon.svg" alt="Hubinho" className="w-10 h-6" />, label: 'Hubinho', href: '/transportadora/assistente' },
