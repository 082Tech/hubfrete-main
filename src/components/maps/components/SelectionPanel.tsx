...
const STATUS_CONFIG: Record<string, { label: string; className: string }> = {
  ...
  em_entrega: { label: 'Em Entrega', className: 'bg-violet-500/10 text-violet-600 border-violet-500/20' },
  entregue: { label: 'Entregue', className: 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20' },
