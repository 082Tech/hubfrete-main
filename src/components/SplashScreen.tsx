  ...
  return <AnimatePresence>
      ...
      ease: 'easeOut'
          ...
          ease: [0.16, 1, 0.3, 1]
              ...
              <motion.p className="text-primary-foreground/70 text-sm mt-2 font-medium tracking-wide" initial={{
            opacity: 0
          }} animate={stage >= 1 ? {
            opacity: 1
          } : {}} transition={{
            ...
            <motion.div className="flex gap-1.5 mt-4" initial={{
          opacity: 0
        }} animate={stage >= 1 ? {
          opacity: 1
        } : {}} transition={{
          ...
          delay: 0.7
              ...
              {[0, 1, 2].map(i => <motion.div key={i} className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40" animate={{
            opacity: [0.4, 1, 0.4],
            scale: [1, 1.2, 1]
          }} transition={{
            duration: 1,
