...
interface ContatosSettingsTabProps {
  empresaId: number;
}
      ...
      <Card className="border-border">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>
              Gerencie seus destinatários e remetentes salvos
            </CardDescription>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Button onClick={() => setNovoContatoOpen(true)} className="gap-2">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                {searchTerm 
                  ...
                  : 'Adicione contatos clicando no botão acima'}
              </p>
              {!searchTerm && (
                <Button onClick={() => setNovoContatoOpen(true)} variant="outline" className="gap-2">
                  <Plus className="w-4 h-4" />
