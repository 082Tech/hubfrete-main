...
import { Truck, ArrowLeft, Building2, Phone, Mail, FileText, MapPin, User, Lock, Info, CheckCircle, Loader2 } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="razaoSocial" name="razaoSocial" placeholder="Razão social da transportadora" value={formData.razaoSocial} onChange={handleChange} required />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" name="email" type="email" placeholder="contato@transportadora.com" value={formData.email} onChange={handleChange} required />
                </div>
                <div className="space-y-2">
