...
export default function Assistente() {
  ...
  return (
    <PortalLayout expectedUserType="embarcador">
      {/* Full container with gradient background - fills content area */}
      <div className="relative min-h-[calc(100vh-4rem)] -m-8 p-8 overflow-hidden">
        ...
        {/* Content container */}
        <div className="relative z-10 h-[calc(100vh-8rem)] flex flex-col">
          {/* Header */}
