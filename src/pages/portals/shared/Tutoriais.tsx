...
const tutorials: Tutorial[] = [
  ...
  {
    id: '2',
    title: 'Como publicar sua primeira carga',
    description: 'Passo a passo completo para criar e publicar uma oferta de carga.',
    duration: '8 min',
    category: 'Cargas',
  ...
  {
    id: '3',
    title: 'Gerenciando entregas em andamento',
    description: 'Acompanhe entregas, visualize status em tempo real e gerencie documentos.',
    duration: '6 min',
    category: 'Entregas',
