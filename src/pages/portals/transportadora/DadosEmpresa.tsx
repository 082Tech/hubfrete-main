    ...
    <div className="h-full overflow-auto p-4 md:p-8">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Informações da transportadora vinculada</p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
              <div className="relative group shrink-0">
                <div className="w-24 h-24 rounded-lg bg-muted border-2 border-dashed border-muted-foreground/25 flex items-center justify-center overflow-hidden shrink-0">
                  {companyInfo?.logo_url ? (
                    <img src={companyInfo.logo_url} alt="Logo da Transportadora" className="w-full h-full object-contain" />
                  ) : (
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Recomendado: 512x512px (PNG ou JPG, max 2MB). Esta logo será exibida nos seus perfis operacionais e faturas.
                </p>
              </div>
            </div>
