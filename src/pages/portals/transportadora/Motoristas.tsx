    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          ...
          veiculos:veiculos!veiculos_motorista_padrao_id_fkey(id, placa, tipo, marca, modelo, uf, antt_rntrc, documento_veiculo_url, comprovante_endereco_proprietario_url, proprietario_nome, proprietario_cpf_cnpj, carroceria_integrada, capacidade_kg, capacidade_m3),
