...
import { Truck, ArrowLeft, Building2, Phone, Mail, User, Info, CheckCircle } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { supabase } from '@/integrations/supabase/client';

export default function PreCadastroTransportadora() {
        ...
        <Card className="w-full max-w-lg border-border/50 shadow-xl">
          <CardContent className="pt-8 pb-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Recebemos seu pré-cadastro como transportadora. Nossa equipe irá analisar 
      ...
      <div className="w-full max-w-lg">
        ...
        <Card className="border-border/50 shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-2xl font-bold">Pré-Cadastro de Transportadora</CardTitle>
            <CardDescription>
              Solicite acesso à plataforma para gerenciar fretes e motoristas
            </CardDescription>
          </CardHeader>
