...
-- NF-e permite até 4 casas decimais para peso
-- ═══════════════════════════════════════════════════════════════
...
-- 4) veiculos (se existir capacidade_kg)
DO $$
BEGIN
  IF EXISTS (
...
-- 5) Atualizar accept_carga_tx para aceitar NUMERIC em vez de INTEGER
...
-- 6) Atualizar trigger release_weight_on_entrega_cancel (usa NUMERIC agora, mas a lógica não muda)
-- Já funciona com NUMERIC pois usa COALESCE e operadores aritméticos padrão.
