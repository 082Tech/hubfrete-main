...
CREATE TABLE public.solicitacoes_antecipacao (
...
CREATE INDEX idx_solicitacoes_antecipacao_status ON public.solicitacoes_antecipacao(status);
CREATE INDEX idx_solicitacoes_antecipacao_financeiro ON public.solicitacoes_antecipacao(financeiro_entrega_id);
